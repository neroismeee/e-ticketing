    ...
    public function run(): void
    {
        ...
        for ($i=0; $i < 10; $i++) {
            FeatureRequest::create([
                ...
                'request_type' => $faker->randomElement(['new_feature', 'enhancement', 'improvement']),
                'priority' => $faker->randomElement(['low', 'medium', 'high']),
                'status' => $faker->randomElement(['pending', 'approved', 'rejected']),
                'progress' => $faker->numberBetween(0, 100),
                'reporter_id' => $faker->numberBetween(1, 10),
                'assigned_to_id' => $faker->numberBetween(1, 10),
                'assigned_team' => $faker->randomElement(['development', 'design', 'marketing']),
                ...
                'post_implementation_review' => $faker->optional()->paragraph,
